...
-- Cars in review
INSERT INTO sales.reviewed_cars (car_id, employee_id, status_id) 
	(SELECT 1, 2, id FROM operations.operations_type WHERE name = 'selected');
INSERT INTO sales.reviewed_cars (car_id, employee_id, status_id) 
	(SELECT 3, 4, id FROM operations.operations_type WHERE name = 'selected');
INSERT INTO sales.reviewed_cars (car_id, employee_id, status_id)
	(SELECT 4, 6, id FROM operations.operations_type WHERE name = 'selected');
INSERT INTO sales.reviewed_cars (car_id, employee_id, status_id)
	(SELECT 5, 7, id FROM operations.operations_type WHERE name = 'selected');
INSERT INTO sales.reviewed_cars (car_id, employee_id, status_id)
	(SELECT 6, 4, id FROM operations.operations_type WHERE name = 'selected');
INSERT INTO sales.reviewed_cars (car_id, employee_id, status_id)
	(SELECT 7, 4, id FROM operations.operations_type WHERE name = 'selected');
